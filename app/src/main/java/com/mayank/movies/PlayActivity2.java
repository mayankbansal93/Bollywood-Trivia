...
public class PlayActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                LayoutInflater lf = LayoutInflater.from(PlayActivity2.this);
                View view = lf.inflate(R.layout.dialog, null);
                adb = new AlertDialog.Builder(PlayActivity2.this);
                adb.setView(view);
                    ...
                    adb.setPositiveButton("NEXT LEVEL", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            if (level_no > Movie.name.length) {
                                ...
                                editor.commit();
                                Intent i2 = new Intent(PlayActivity2.this, FinalActivity.class);
                                ...
                                editor.commit();
                                Intent i2 = new Intent(PlayActivity2.this, PlayActivity.class);
